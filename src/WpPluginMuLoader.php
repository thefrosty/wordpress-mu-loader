...
namespace TheFrosty\WpPluginMuLoader;
...
use function get_network_option;
...
use function substr;
use function update_network_option;
use function update_option;
use function validate_file;
use function wp_create_nonce;
use function wp_die;
use function wp_json_encode;
use function wp_register_plugin_realpath;
 ...
 * @package TheFrosty\WpPluginMuLoader
...
class WpPluginMuLoader
{
    ...
    public function filterPluginMetaCaps(array $caps, ?string $cap, ?int $user_id, array $args): array
    {
        switch ($cap) {
             ...
             */
            case 'delete_plugins':
                if (isset($_REQUEST['checked'])) { // phpcs:ignore
                    $plugins = wp_unslash($_REQUEST['checked']); // phpcs:ignore
